...
const selectedDeck = computed(() =>
    props.decks.find(d => d.deck_id === props.modelValue) ?? null
)
...
const groupedOptions = computed(() => {
    ...
    for (const [system, decks] of Object.entries(systemGroups).sort((a, b) => a[0].localeCompare(b[0]))) {
            ...
            <template v-if="groupedOptions.length > 0">
                <template v-for="group in groupedOptions" :key="group.label">
                    ...
                    <div
                        ...
                        :class="{ 'is-highlighted': flatItems.indexOf(deck) === highlightIndex, 'is-selected': deck.deck_id === modelValue }"
                    ...
                    >
                        ...
                        <span v-if="deck.additional_cards > 0" class="deck-combobox__extra ml-2">+{{ deck.additional_cards }}</span>
                        <span
                            v-if="isLoggedIn"
