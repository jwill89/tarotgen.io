...
function collect(): { reading_name: string; hide_user: boolean; password: string; reading_notes: string } | null {
...
<template>
    <div class="box reading-owner-options" v-if="isLoggedIn">
        <p class="label">
            Reading Options
        ...
        <div class="field">
            <label class="label" for="ro-name">Reading Title <span class="has-text-grey is-size-7 has-text-weight-normal">(optional)</span></label>
            <input class="input" id="ro-name" v-model="readingName" maxlength="100" autocomplete="off" placeholder="e.g. Morning reflection" />
        </div>

        <div class="field">
            <label class="toggle-switch">
                <input type="checkbox" v-model="hideUser" />
        ...
        <div class="field">
            <label class="label" for="ro-password">View Password <span class="has-text-grey is-size-7 has-text-weight-normal">(optional)</span></label>
            <input
                class="input"
                id="ro-password"
            ...
            <label class="toggle-switch mt-2" v-if="password">
        ...
        <div class="field" v-if="notes">
            ...
            <MarkdownEditor v-model="readingNotes" placeholder="Write a detailed interpretation… Markdown is supported." />
            <p class="help">A longer written explanation, shown in a collapsible section on the reading.</p>
        </div>
    </div>
