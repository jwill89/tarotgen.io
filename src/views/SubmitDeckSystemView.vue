        ...
        <div class="container" style="max-width: 900px">
            ...
            <template v-if="!isLoggedIn">
                <div class="notification is-warning">
                    <p>You must be <router-link :to="{ name: 'login', query: { redirect: '/submit-deck-system' } }">logged in</router-link> to submit a deck system.</p>
                </div>
            </template>
            ...
            <template v-else>
                <div class="notification is-info is-light">
                    <p>A deck system defines the card names and meanings used by one or more decks. For example, "Rider-Waite-Smith" and "Thoth" are two different deck systems. Each card must have at least a name.</p>
                </div>
                ...
                <div class="columns">
                    <div class="column is-5">
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="text" v-model="name" placeholder="e.g. Marseille" />
                            </div>
                        </div>
                    </div>
                    <div class="column is-4">
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="text" v-model="shortName" placeholder="e.g. TdM" />
                            </div>
                    ...
                    <div class="column is-3">
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="number" v-model.number="totalCards" min="1" max="200" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <p class="mb-4 has-text-grey">Enter a name for each card. All other fields are optional but helpful.</p>
