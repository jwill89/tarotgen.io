...
async function clearAll() {
    const ok = await confirm({
        ...
        message: 'Remove all readings from your history on this device? The readings themselves are not deleted — you can still open them with their code.',
...
<template>
    <section class="section">
        <div class="container">
            ...
            <div class="recent-readings" v-if="recent.length > 0">
