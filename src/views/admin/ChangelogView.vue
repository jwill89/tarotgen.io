...
<template>
    <section class="section">
        <div class="container">
            ...
            <p class="has-text-grey" v-if="entries.length === 0">No entries yet. Click "Add Entry" to create one.</p>
        </div>
    </section>
    ...
    <BaseModal
        ...
        @close="closeEdit"
    >
        <div class="notification is-danger" v-if="errorMsg">{{ errorMsg }}</div>

        <div class="field">
            <label class="label" for="cl-title">Title</label>
            <input class="input" id="cl-title" v-model="form.title" maxlength="200" autocomplete="off" />
        </div>

        <div class="field">
            <label class="label" for="cl-date">Date</label>
            <input class="input" id="cl-date" type="date" v-model="form.entry_date" />
        </div>

        <div class="field">
            <label class="label" for="cl-body">Body</label>
            <textarea class="textarea" id="cl-body" v-model="form.body" rows="8"></textarea>
