        ...
        <table class="table is-fullwidth is-hoverable is-striped">
          ...
          <tbody>
            <tr v-for="deck in visibleDecks" :key="deck.deck_id">
              ...
              <td>
                <span v-if="deck.usable" class="tag is-success is-light mr-1">Usable</span>
                <span v-else class="tag is-light mr-1">Not Usable</span>
              </td>
              <td>
                <div class="buttons are-small">
                  <button
                  ...
                  >
                    <span class="icon"
                      ><FontAwesomeIcon :icon="byPrefixAndName.fas['images']"
                    /></span>
    ...
    <template v-if="editingDeck">
      ...
      <div class="columns">
        <div class="column is-6">
          <div class="field">
            ...
            <input
              v-model.number="editingDeck.additional_cards"
              class="input"
              type="number"
              min="0"
            />
      ...
      <div class="field">
        ...
        <div class="field has-addons">
          <p class="control">
            <input
              v-model.number="editingDeck.card_aspect_w"
              class="input"
              type="number"
              step="0.1"
              min="0.1"
          ...
          <p class="control">
            <input
              v-model.number="editingDeck.card_aspect_h"
              class="input"
              type="number"
              step="0.1"
              min="0.1"
