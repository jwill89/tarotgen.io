...
import {
    ...
    faEnvelope, faEnvelopeCircleCheck, faEnvelopeOpen, faEye, faEyeSlash,
    faFloppyDisk, faFont, faForward, faGaugeHigh, faGear, faGlobe, faGrid2Plus,
    ...
    faScroll, faShuffle, faSort, faSortDown, faSortUp, faSparkles, faSpinner,
    faStar, faSword,
    faTableCells, faTrash, faTriangleExclamation, faUnlock,
    faUser, faUserPlus, faUserShield, faUsers,
...
function index(defs: IconDefinition[]): Record<IconPrefix, Record<string, IconDefinition>> {
    const map = {} as Record<IconPrefix, Record<string, IconDefinition>>
...
export const byPrefixAndName = index([
    ...
    fadClockRotateLeft, fadCrystalBall, fadEnvelope, fadGear, fadGrid2Plus,
    fadHandHoldingMagic, fadLayerGroup, fadNewspaper, fadRightFromBracket,
    fadScroll, fadScrollOld, fadSparkles, fadTableCells, fadUsers,
    // regular (far)
    farStar,
    // brands (fab)
    faGoogle,
