...
.toast-item--error   { border-left-color: #f87171; }
.toast-item--warning { border-left-color: #fbbf24; }
.toast-item--info    { border-left-color: #a78bfa; }

.toast-icon { flex: none; margin-top: 0.1rem; }
...
.toast-item--info    .toast-icon { color: #a78bfa; }
